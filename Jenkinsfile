        ...
        stage("Test - ${jdk}") {
          timeout(time: 90, unit: 'MINUTES') {
            ...
            withMaven(
                    ...
                    mavenOpts: mavenOpts,
                    mavenLocalRepo: localRepo) {
              sh "mvn -V -B install -Dmaven.test.failure.ignore=true -e -Pmongodb -T3 -Djunit.jupiter.execution.parallel.enabled=true -Djunit.jupiter.execution.parallel.config.fixed.parallelism=8 -Dunix.socket.tmp="+env.JENKINS_HOME
            }
