...
public class ServerCloseCreator implements WebSocketCreator
{
    ...
    private LinkedBlockingQueue<AbstractCloseSocket> createdSocketQueue = new LinkedBlockingQueue<>();
    ...
    {
        AbstractCloseSocket closeSocket = null;
    ...
    public AbstractCloseSocket pollLastCreated() throws InterruptedException
    {
